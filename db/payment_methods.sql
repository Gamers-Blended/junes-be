...
(
    ...
    card_fingerprint         VARCHAR(32)  NOT NULL,
...
CREATE UNIQUE INDEX idx_active_card_fingerprint_per_user ON junes_rel.payment_methods (user_id, card_fingerprint) WHERE is_active = true;