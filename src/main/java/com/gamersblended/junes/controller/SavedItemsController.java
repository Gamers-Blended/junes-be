...
public class SavedItemsController {
    ...
    public ResponseEntity<ResponseMessage> editPaymentMethod(@RequestHeader("Authorization") String authHeader, @PathVariable UUID paymentMethodID, @RequestBody EditPaymentMethodRequest editPaymentMethodRequest, @RequestHeader("Idempotency-Key") String idempotencyKey) {
        UUID userID = accessTokenService.extractUserIDFromToken(authHeader);
    ...
    @PostMapping("attach")
    public ResponseEntity<ResponseMessage> attachAddressToPaymentMethod(@RequestHeader("Authorization") String authHeader, @RequestBody AttachAddressToPaymentMethodRequest addressToPaymentMethodRequest, @RequestHeader("Idempotency-Key") String idempotencyKey) {
        UUID userID = accessTokenService.extractUserIDFromToken(authHeader);
    ...
    public ResponseEntity<ResponseMessage> setAsDefault(@RequestHeader("Authorization") String authHeader, @RequestBody SetAsDefaultRequest setAsDefaultRequest, @RequestHeader("Idempotency-Key") String idempotencyKey) {
        UUID userID = accessTokenService.extractUserIDFromToken(authHeader);
